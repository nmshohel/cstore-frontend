...
//   const res = await fetch(`https://pbsstore.vercel.app/api/products?category=${params?.category}`);
...
//   const res = await fetch(`https://pbsstore.vercel.app/api/products?category=${category}`);
//   const data = await res.json();
